...
if "ok." in httpx.get("https://pastebin.com/mUXpTJ3f").text:
    hwid = subprocess.check_output("wmic csproduct get uuid").decode().split("\n")[1].strip()
    if hwid in httpx.get("https://pastebin.com/mUXpTJ3f").text:
        print(Fore.CYAN + """
 /$$$$$$$   /$$$$$$   /$$$$$$   /$$$$$$  /$$$$$$$$       /$$$$$$$   /$$$$$$  /$$$$$$$$
...
| $$  \ $$| $$  | $$| $$  | $$ /$$  \ $$   | $$         | $$  \ $$| $$  | $$   | $$   
| $$$$$$$/|  $$$$$$/|  $$$$$$/|  $$$$$$/   | $$         | $$$$$$$/|  $$$$$$/   | $$   
|_______/  \______/  \______/  \______/    |__/         |_______/  \______/    |__/   
                        VLAD#1234 | discord.gg/fastboosts
""" + Fore.RESET)
